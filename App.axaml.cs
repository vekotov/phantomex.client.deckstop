...
using Phantomex.Common.Configuration;
using Phantomex.Core;
using Atomex.MarketData.Bitfinex;
using Phantomex.Services;
using Phantomex.Client.Desktop.Dialogs.Views;
using Phantomex.Client.Desktop.Services;
using Phantomex.Client.Desktop.ViewModels;
using Phantomex.Client.Desktop.Views;
using Avalonia;
...
namespace Phantommex.Client.Desktop
{
